# Actor is the main of RL developed from basic_model, to help the model learn by a policy  
# Also help to calculate reward, loss of RL model
import torch
import torch.nn as nn
import torch.nn.functional as F

from Models.base_models import Embedding, Pointer, Attention

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

class DRL4VRP(nn.Module):
    """Defines the main Embedding, Decoder, and Pointer combinatorial models.
    ...
    dynamic_size: int > 1
        ...
        (e.g. 2 for the VRP which has (load, demand) attributes. The VRP doesn't
    ...
    def __init__(self, static_size, dynamic_size, hidden_size,
        ...
        self.decoder = Embedding(static_size, hidden_size)
